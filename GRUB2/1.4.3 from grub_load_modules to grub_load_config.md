...
command to grub commmand, every command has a dedicated response function to process specific operation from console. All grub commands stored in grub\_command\_list, allocate memory for new command and insert it to the list.
