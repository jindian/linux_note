...
of course after load normal module in next stage, there are more modules will be loaded.

# _set root device_

Before get to grub\_load\_normal\_module, there are several routines, let's check these routines one by one.
