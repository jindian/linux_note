...
`grub_dl_check_license` checks license of the module, it loops all sections of the module in memory, until it finds the section storing module license information

```c
grub_dl_check_license (e=0x7fe7480) at kern/dl.c:470
470	  s = (Elf_Shdr *) ((char *) e + e->e_shoff + e->e_shstrndx * e->e_shentsize);

  ......

473	  for (i = 0, s = (Elf_Shdr *) ((char *) e + e->e_shoff);
(gdb) 
476	    if (grub_strcmp (str + s->sh_name, ".module_license") == 0)
(gdb) p str + s->sh_name
$17 = 0x7fe7775 ""
...
(gdb) p str + s->sh_name
$19 = 0x7fe7790 ".rel.text"

  ......

(gdb) p str + s->sh_name
$20 = 0x7fe779a ".rodata.str1.1"
...
(gdb) p str + s->sh_name
$22 = 0x7fe77a9 ".rel.data"

  ......

(gdb) p str + s->sh_name
$23 = 0x7fe77b3 ".module_license"

```

grub\_dl\_resolve\_name 
